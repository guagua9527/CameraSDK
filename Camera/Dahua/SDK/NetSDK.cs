...
namespace CameraSDK.Camera.Dahua.SDK
{
    public static class NETClient
    {
        ...
        /// 注册画图回调
        /// </summary>
        /// <param name="fDrawCall"></param>
        /// <param name="dwUser"></param>
        public static void NetRigisterDrawFun(fDrawCallBack fDrawCall, IntPtr dwUser)
        {
            OriginalSDK.CLIENT_RigisterDrawFun(fDrawCall, dwUser);
        }
